@extends('layouts.app')
@section('title','REPORT - LEARNING AND DEVELOPMENT (L&D) INTERVENTIONS/TRAINING PROGRAMS ATTENDED ')
                                      ...
                                      <table class="table table-bordered table-striped table-hover data-table-report  dataTable" id="data-table-report"  style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="5%">Dept</th> 
                                                <th width="25%">Title of Learning</th>
                                                <th>From</th>
                                                <th>To</th>
                                                <th width="5%">Hours</th>
                                                <th width="10%"><small>Type of </small> LD</th>
                                                <th><small>Sponsored By</small></th>
                                            </tr>
                                        </thead>
                                        <tfoot>
                                            <tr>
                                        ...
                                        <tbody>
                                              ...
                                              @foreach ($report_data as $key => $value)
                                                <tr class="data">
                                                    ...
                                                    <td><small>{!! ucwords($value->title_of_learning) !!}</small></td>
                                                    ...
                                                    <td><small>{!! ucwords($value->number_of_hours) !!}</small></td>
                                                    <td><small>{!! ucwords($value->type_of_ld) !!}</small></td>
                                                    <td><small>{!! ucwords($value->conducted_sponsored_by) !!}</small></td>
                ...
                dom: 'Bfrtip',
                   buttons: [
                  {
                        ...
                        title: function() {
                            ...
                            @if(Request::segment(3) == 'all')
                             return "LEARNING AND DEVELOPMENT (L&D) INTERVENTIONS/TRAINING PROGRAMS ATTENDED ";
                            @else
                             return "{!! App\Http\Models\PersonalInformation::get_name($uid) !!} - LEARNING AND DEVELOPMENT (L&D) INTERVENTIONS/TRAINING PROGRAMS ATTENDED";
                            @endif
                          },
