...
<div class="container-fluid">
  ...
  <div style="margin-left: 23px;">
    <img src="{{ asset('admin-assets/images/doh-ro2-header.jpg') }}" height="100" width="570" />
  </div>
  ...
  <div style="text-align: justify;">
    ...
    <br><br>
    <!-- &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This is to CERTIFY that as per record on file in this Office, (NAME HERE), is a (POSITION TYPE) - (POSITION HERE) of the Department of Health, Regional Office No. 02  from the period (FROM DATE) to (TO DATE).
    <br><br>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;This certification is issued upon request of (MR./MRS./MS. LASTNAME) for whatever legal purpose it may serve her best.
    <br><br>
