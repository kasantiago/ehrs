@extends('layouts.app')
@section('title','REPORT - WORK EXPERIENCE')
                                      ...
                                      <table class="table table-bordered table-striped table-hover data-table-report  dataTable" id="data-table-report"  style="width:100%">
                                        <thead>
                                           ...
                                           <!--      <th width="20%">Status</th> 
                                                ...
                                                <th>From</th>
                                                <th>To</th>
                                                <th>Department/Agency/Office</th>
                                                <th width="5%">Salary</th>
                                                <th width="5%">Paygrade</th>
                                                <th width="5%">Status of Appointment</th>
                                                <th width="3%">Gov't Service</th>
                                        ...
                                        <tbody>
                                           ...
                                           <!--          <td>{!! strtoupper($value->employee_status) !!}</td>
                                                    ...
                                                    <td><small>{!! number_format($value->monthly_salary ,2,'.', ',')  !!}</small></td>
                                                    <td><small><center>{!! ucwords($value->paygrade) !!}</center></small></td>
                                                    <td><small>{!! ucwords($value->status_of_appointment) !!}</small></td>
                                                    <td><small><center>{!! ucwords($value->govt_service) !!}</center></small></td>
                    ...
                    },
                    {
                        ...
                        title: function() {
                            @if(Request::segment(3) == 'all')
                             return "REPORT - WORK EXPERIENCE";
                            @else
                             return "{!! App\Http\Models\PersonalInformation::get_name($uid) !!} - WORK EXPERIENCE";
                            @endif
                          }, 
