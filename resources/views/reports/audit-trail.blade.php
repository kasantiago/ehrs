@extends('layouts.app')
@section('title','REPORT - AUDIT TRAIL')
                        ...
                        <div class="header">
                            <h2>
                                 @if($type == "admin")
                                    AUDIT TRAIL
                                 @else
                                  <h3>{!! App\Http\Models\PersonalInformation::get_name($uid) !!} - AUDIT TRAIL</h3>
                                 @endif
                            </h2>
                        </div>
                        <div class="body">
                                                ...
                                                <tr>
                                                    ...
                                                    <td> 
                                                        @if($type == "admin")
                                                            {!! $value->name !!}
                                                        @endif
                                                         <span class="{{ $color[1] }}">{!! $value->logs !!}</span></td>
            ...
            $('#data-table-report').DataTable({
                ...
                dom: 'Bfrtip',
                    buttons: [
                    {
                        ...
                        title: function() {
                            @if($type == "admin")
                             return "REPORT - AUDIT TRAIL";
                            @else
                             return "{!! App\Http\Models\PersonalInformation::get_name($uid) !!} - AUDIT TRAIL";
                            @endif
                          },
