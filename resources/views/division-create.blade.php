...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form method="POST" novalidate="novalidate" action="{{ url('account/division/store') }}">
                    ...
                    {{ csrf_field() }}
                       ...
                       <div class="col-md-12" style="display:none;">
                            <div class="form-group">
                                <input type="checkbox" name="leave_approval_setting" id="leave_approval_setting" value="1"  class="filled-in" >
