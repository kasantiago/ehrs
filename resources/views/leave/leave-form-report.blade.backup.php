  ...
  <div style="margin-top: 15px;">
    <table class="table" style="width: 95%;" >
      <tbody>
          ...
          <td style="height: 15px; border-top: 0; border-bottom: 0; text-align: center;"> <div style=" border-bottom: 1px solid black; width:76px;float:left;margin-left:13px; " ><center>
           ...
           @elseif($data->six_a_type_of_leave == 'sick')
            ...
            @if( $data->six_c_for > $latest->sick_balance)
                ...
                @if($latest->vacation_balance -  ( $data->six_c_for - $latest->sick_balance ) > 0)
                <strike>{{ $latest->vacation_balance }}</strike> {{ $latest->vacation_balance -  ( $data->six_c_for - $latest->sick_balance ) }}
                @else
                    <strike>{{ $latest->vacation_balance }}</strike> 
                @endif
              ...
              @elseif($data->six_a_type_of_leave == 'sick')
                      ...
                      @if( $data->six_c_for > $latest->sick_balance)
                                    @if($latest->vacation_balance -  ( $data->six_c_for - $latest->sick_balance ) > 0)
                                     ...
                                     {{ $latest->sick_balance  }} + {{ $data->six_c_for - $latest->sick_balance }}
                                    @else
                                      S+V = {{ $latest->sick_balance + $latest->vacation_balance }} 
                                    @endif

                    @elseif( $data->six_c_for < $latest->sick_balance)
        ...
        <tr>
         @if($data->six_a_type_of_leave == 'vacation' || $data->six_a_type_of_leave == 'force')
            <td style="height: 15px; border-top: 0; border-bottom: 0; text-align: center;"> <div style=" border-bottom: 1px solid black; width:76px;float:left;margin-left:13px; " ><center> {{ ($latest->vacation_balance - $data->six_c_for < 0)? $latest->vacation_balance :  $data->six_c_for }}   </center></div> </td>
            <td style="border-top: 0; border-bottom: 0; text-align: center;"><div style=" border-bottom: 1px solid black; width:76px;float:left;margin-left:13px; " ><center> <!-- content---> &nbsp;&nbsp;  </center></div></td>
         ...
         @elseif($data->six_a_type_of_leave == 'sick')
           ...
           @if( $data->six_c_for > $latest->sick_balance)
                            ...
                            @else
                              {{ $latest->sick_balance + $latest->vacation_balance }} 
                            @endif
         ...
         @else
             ...
             <td style="border-top: 0; border-bottom: 0; text-align: center;"><br></td>
             <td style="border-top: 0; border-bottom: 0; text-align: center;"><br></td>
        ...
        <tr>
          @if($data->six_a_type_of_leave == 'vacation' || $data->six_a_type_of_leave == 'force')
            ...
            <td style="height: 15px; border-top: 0; border-bottom: 0; text-align: center;"><div style=" border-bottom: 1px solid black; width:76px;float:left;margin-left:13px; " ><center>{{ ($latest->vacation_balance - $data->six_c_for > 0)?  $latest->vacation_balance - $data->six_c_for  : $latest->vacation_balance - $data->six_c_for }} </center></div></td>
            ...
            <td style="height: 15px; border-top: 0; border-bottom: 0; text-align: center;"><div style=" border-bottom: 1px solid black; width:76px;float:left;margin-left:13px;" ><center>
              ...
              @if( $data->six_c_for > $latest->sick_balance)
                          ...
                          @else
                             {{ ($latest->sick_balance + $latest->vacation_balance) - $data->six_c_for }} 

                          @endif

              @elseif( $data->six_c_for < $latest->sick_balance)

                              {{ $latest->sick_balance -  $data->six_c_for }}
          ...
          @else
            ...
            <td style="border-top: 0; border-bottom: 0; text-align: center;"><br><br></td>
            <td style="border-top: 0; border-bottom: 0; text-align: center;"><br><br></td>
          ...
          <td style="height: 15px; padding-left: 8px;"><div><div style=" border-bottom: 1px solid black; width:76px;float:left;margin-top:3px; " ><center>&nbsp;{{ $data->six_c_for - $latest->vacation_balance }}</center></div> <div style="float:left">&nbsp; <b>days without pay</b></div></div></td>
            @elseif($data->six_a_type_of_leave == 'sick')
              <td style="height: 15px; padding-left: 8px;"><div><div style=" border-bottom: 1px solid black; width:76px;float:left;margin-top:3px; " ><center>&nbsp;
                  ...
                  {{   $data->six_c_for - ($latest->sick_balance + $latest->vacation_balance)}} 
