...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            ...
            <div class="body">
                <form  method="POST" novalidate="novalidate" action="{{ url('account/position/update/'.encrypt($position->id)) }}">
                    ...
                    {{ csrf_field() }}
                       ...
                       <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control all-caps" name="name"  value="{{ $position->name }}" required aria-required="true">
                       ...
                       <div class="form-group form-float">
                            <div class="form-line focused">
                                <input type="text" class="form-control all-caps" name="details"  value="{{ $position->details }}" required aria-required="true">
