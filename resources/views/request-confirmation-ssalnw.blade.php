            ...
            <div class="body">
                ...
                <div class="eula-modal-content">
                    <div class="button-demo">
                        ...
                        normal;text-align:center;'>Human Resource Unit / Administrator would like to access your <b>Sworn Statement of Assets, Liabilities and Net Worth</b>. Please press approve if you approved our request or vice versa.</p>
                    
                        <br>

                        <center>
                             <form method="POST" novalidate="novalidate" action="{{ url('sworn-statement-assets-liabilities-net-worth/confirm') }}">
                                {{ csrf_field() }}
