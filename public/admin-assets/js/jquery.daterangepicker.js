...
(function($)
{
      ...
      $.dateRangePickerLanguages =
      {
            'az':
            {
                  ...
                  'week-6' : '6',
                  'week-7' : '7',
                  'month-name': ['Yanvar','Fevral','Mart','Aprel','May','Ä°yun','Ä°yul','Avqust','Sentyabr','Oktyabr','Noyabr','Dekabr'],
            ...
            'cz':
            {
                  ...
                  'week-6' : 'So',
                  'week-7' : 'Ne',
                  'month-name': ['Leden','Ãšnor','BÅ™ezen','Duben','KvÄ›ten','ÄŒerven','ÄŒervenec','Srpen','ZÃ¡Å™Ã­','Å˜Ã­jen','Listopad','Prosinec'],
                  'shortcuts' : 'Zkratky',
                  'past': 'po',
            ...
            'ru':
            {
                  ...
                  'week-6': 'Ð¡Ð‘',
                  'week-7': 'Ð’Ð¡',
                  'month-name': ['Ð¯ÐÐ’ÐÐ Ð¬','Ð¤Ð•Ð’Ð ÐÐ›Ð¬','ÐœÐÐ Ð¢','ÐÐŸÐ Ð•Ð›Ð¬','ÐœÐÐ™','Ð˜Ð®ÐÐ¬','Ð˜Ð®Ð›Ð¬','ÐÐ’Ð“Ð£Ð¡Ð¢','Ð¡Ð•ÐÐ¢Ð¯Ð‘Ð Ð¬','ÐžÐšÐ¢Ð¯Ð‘Ð Ð¬','ÐÐžÐ¯Ð‘Ð Ð¬','Ð”Ð•ÐšÐÐ‘Ð Ð¬'],
